...
class RouteNode_Test 
{
	...
	void routeNode_DepartureTimeTest() 
	{
		...
		System.out.println(t_airport1.getConnectionTimeMin().getSeconds());
		System.out.println(temp1.departureTime().getTime());
		System.out.println(temp2.departureTime().getTime());
	}
